# Task Plan: ArcanaCoder — 内容扩展总计划

## Goal
在 Phase 1 核心循环的基础上，将教学内容从 1 章扩展到 10 章，覆盖 Python 基础→现代工程实践全链路。

## Current Phase
Phase 3 — 内容扩展（第 2-4 章数据生成中）
...
| 测试框架 vitest + 覆盖率阈值 60/60/50 | 防回归 |
| 第 9-10 章高阶内容以概念题为主（choice 70%） | Pyodide 无法运行 Rust 工具 |
| 内容体系参考 walter201230/Python 教程结构 | 26.5k star 教程，质量经过验证 |

## Errors Encountered
（见 `findings.md` 完整记录）

## 历史遗留问题（Phase 1 已全部关闭）
- narrativeExplanation 28 题已补齐 ✅
- hintRoleplay 语气调整已完成 ✅
- GDD 术语 22+ 处违规已替换 ✅
...
| P1 | 4 | 条件判断与循环 | 22 | 🔲 |
| P1 | 5 | 函数与模块 | 20 | 🔲 |
| P1 | 6 | 异常处理与 pathlib | 20 | 🔲 |
| P2 | 7 | 面向对象 | 22 | 🔲 |
| P2 | 8 | 类型注解、dataclass 与上下文管理器 | 20 | 🔲 |
| P3 | 9 | pytest、logging 与 ruff 规范 | 18 | 🔲 |
| P3 | 10 | async/await、uv 与打包发布 | 18 | 🔲 |

### Phase 4：代码改造
- [ ] ChapterSelect 硬编码迁移（chapterNames / sectionNames / 地图区域）
- [ ] 智慧之书追加条目

### Phase 5：像素风美术（原路线图 Phase 4 不变）
- [ ] AI 生成 22 张像素画
- [ ] CSS 帧动画替换纯色块
